...
#'
#' @description Calculate the fit metrics of the augmented data against the
#' observed data.
#'
#' @param aug_vals A vector of the augmented values.
#' @param org_vals A vector of the original observed values.
#' 
aug_fit <- function(
  aug_vals,
  org_vals
